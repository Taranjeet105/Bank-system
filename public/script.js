...
function Send() {
  const url = "https://shantys-banksystem.herokuapp.com/sent";
...
function Transfer() {
  ...
  const url = `https://shantys-banksystem.herokuapp.com/transfer`;
...
function SendMoney() {
  ...
  const url = "https://shantys-banksystem.herokuapp.com/transferred";
  console.log(data);
  fetch('/transferred', {
    method: "POST",
    headers: {
    ...
    .then(res2 => {
      ...
      if (res2.error === true) {
        ...
        window.location.replace("https://shantys-banksystem.herokuapp.com/transactions")
      }
      // location.reload()
    });
...
function Goback() {
  const url = "https://shantys-banksystem.herokuapp.com/customers";
  window.location.replace(url);
}
